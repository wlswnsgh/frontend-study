...
const Clbox = document.querySelector('.box');

Clbox.addEventListener('click', function(){
  console.log('Hello~');
...
const spEl = document.querySelectorAll('span');
spEl.forEach(function(spanEl, index) {
  console.log(spanEl);
